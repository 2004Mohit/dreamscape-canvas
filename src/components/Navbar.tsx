...
export function Navbar() {
  ...
  useEffect(() => {
    const onScroll = () => setScrolled(window.scrollY > 7000);
    onScroll();
  ...
  return (
    <>
      ...
      {/* Mobile menu - intentionally OUTSIDE the fixed header */}
      {open && (
        <div
          className="
    fixed
        ...
        >
          ...
          <div className="mt-8 space-y-4">
            ...
            <div className="label-xs space-y-2 text-muted-foreground">
              ...
              <a href={company.emailHref} className="block break-all hover:text-primary">
                {company.email}
              </a>
